...
class ProjetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projet" do
    assert_difference("Projet.count") do
      post projets_url, params: { projet: { dateEnd: @projet.dateEnd, dateStart: @projet.dateStart, description: @projet.description, image: @projet.image, reference: @projet.reference, title: @projet.title, type: @projet.type } }
    end
  ...
  test "should update projet" do
    patch projet_url(@projet), params: { projet: { dateEnd: @projet.dateEnd, dateStart: @projet.dateStart, description: @projet.description, image: @projet.image, reference: @projet.reference, title: @projet.title, type: @projet.type } }
